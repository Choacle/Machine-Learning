...
for column in range(0,12):
    ...
    Mse = Multi_RegRession(X_train_S,Y_train_S,X_test_S,Y_test_S,"l")[4]
...
print(Best_Sd_x)
Best_Sd_x = Best_Sd_x.values

kf = FoldCross(Best_Sd_x,Sdata_y)
labels = kf.index
R2 = kf.R2
MSE = kf.MSE
...
# \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\  QUESTİON _ 6 ///////////////////////
X_train, X_test, Y_train, Y_test = train_test_split(Best_Sd_x,Sdata_y,test_size=0.2, random_state=99)
regressionCode = ["l","R","L","E","K","D","RF","S"]
regname = ["Linear", "Ridge", "Lasso", "ElasticNet", "K-NN", "Decision Tree", "Random Forest", "SVR"]
i=0
# \\\\\\\\\\\\\ Residual ////////////////////////
