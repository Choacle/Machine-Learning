...
# \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\  QUESTİON _ 3 ///////////////////////
X = standartizedData.drop(y_column, axis=1)
X.hist(bins=10,figsize=(16,9),grid=False)

# \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\  QUESTİON _ 4_5 ///////////////////////
kf = FoldCross(Sdata_x,Sdata_y)
...
# \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\  QUESTİON _ 6 ///////////////////////
X_train, X_test, Y_train, Y_test = train_test_split(Sdata_x,Sdata_y,test_size=0.2, random_state=99)
regressionCode = ["l","R","L","E","K","D","RF","S"]
regname = ["Linear", "Ridge", "Lasso", "ElasticNet", "K-NN", "Decision Tree", "Random Forest", "SVR"]
i=0
for name in regressionCode:
